...
menu = [{'url': '.index', 'title': 'Панель'},
        ...
        {'url': '.listpubs', 'title': 'Список гостей'},
...
def listpubs():
    ...
    if db:
        try:
            ...
            print("Ошибка получения гостей из БД " + str(e))

    return render_template('admin/listpubs.html', title='Список гостей', menu=menu, list=list)
